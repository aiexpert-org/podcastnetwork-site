...
export const socialMediaProfiles = [
  {
    title: 'Instagram',
    href: 'https://instagram.com/podcastnetworkhq',
    icon: InstagramIcon,
  },
  {
    title: 'Facebook',
    href: 'https://facebook.com/podcastnetworkhq',
    icon: FacebookIcon,
  },
  {
    title: 'GitHub',
    href: 'https://github.com/aiexpert-org/podcastnetwork-site',
    icon: GitHubIcon,
  },
  {
    title: 'Dribbble',
    href: 'https://dribbble.com/podcastnetworkhq',
    icon: DribbbleIcon,
  },
]
