      ...
      {status === 'sent' ? (
        <div className="mt-8 rounded-2xl border border-portal-line bg-white p-6">
          ...
          <p className="mt-2 text-sm text-portal-muted">
            ...
            a sign-in link is on its way. It works once and expires in 15
            minutes.
          </p>
          <button
            type="button"
...
function LoginFallback() {
  return (
    <div className="mx-auto w-full max-w-md">
      ...
      <p className="mt-3 text-base text-portal-muted">Loading sign-in…</p>
    </div>
  )
}
...
export default function PortalLoginPage() {
  return (
    <div className="portal-scope flex min-h-screen flex-col justify-center bg-portal-cream px-6 py-16 text-portal-ink">
