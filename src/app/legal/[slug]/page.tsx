...
const PAGES: Record<string, { name: string; summary: string }> = {
  ...
  terms: {
    ...
    summary:
      'Use of PodcastNetwork.org is subject to our terms of service, which cover acceptable use of this site, the ownership of the content published on it, and the limits of any correspondence you send us through it.',
  },
}
