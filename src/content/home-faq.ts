...
export const HOME_FAQ: FaqItem[] = [
  {
    ...
    answer:
      "The Knowledge Panel Install ($24,000 over 12 months, paid up front or split into 12 monthly payments of $2,000 at no extra cost) makes Google and the AI answer engines recognize you as a real entity, then verifies it monthly for a year. The Pre-Sold Author Package ($36,000, delivered in 6 months, paid up front or split into 12 monthly payments of $3,000) produces a finished book from your own voice plus the podcast, voice clone, and author authority to launch it. Both are standalone and application only.",
  },
  {
