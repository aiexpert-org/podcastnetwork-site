...
export const HOME_FAQ: FaqItem[] = [
  {
    ...
    answer:
      "The Brand SERP Install ($24,000 over 12 months, paid up front or split into 12 monthly payments of $2,000 at no extra cost) makes Google and the AI answer engines recognize you as a real entity, then verifies it monthly for a year. The Pre-Sold Author Package ($36,000, delivered in the first 6 months, paid up front or split into 12 monthly payments of $3,000, with payments 7 through 12 funding ongoing monitoring and maintenance) produces a finished book from your own voice plus the podcast, voice clone, and launch infrastructure around it. Both are standalone and application only.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "No. The name describes the goal. The package builds the launch and audience infrastructure that positions you for pre-sales. Actual pre-sales depend on your execution and market fit, and we do not guarantee a number.",
  },
  {
    question: "What makes the two packages different?",
    answer:
      "The Pre-Sold Author Package goes deep on content: a finished book, an audio voice clone, and a voice corpus, all exclusive to it. The Brand SERP Install goes deep on discovery: the Google Knowledge Panel, AI answer engine coverage, Wikipedia and Wikidata, and a full year of monthly verification.",
  },
];
